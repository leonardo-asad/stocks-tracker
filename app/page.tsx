          ...
          <section>
            <div>
              ...
              <p className="text-xl mb-2">
                Stock Tracker allows you to monitor the stock market in
                real-time. Stay updated with the latest prices of your favorite
                stocks.
              </p>
              <p className="text-xl mb-2">
              ...
              <p className="text-xl">
                Make informed decisions with our analysis tools and stay ahead
                in the game.
              </p>
            </div>
            <div className="flex items-center justify-center">
              <a href="/register">
                <Button className="m-8" size="xxl" variant="default">
                  Subscribe
                </Button>
              </a>
            </div>
